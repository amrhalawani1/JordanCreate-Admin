...
import { CHANGE_LOGS_SETUP_SQL } from "@/lib/sql/change-logs-setup";

export function ChangeLogSetup() {
  const [copied, setCopied] = useState(false);

  async function copySql() {
    await navigator.clipboard.writeText(CHANGE_LOGS_SETUP_SQL);
    setCopied(true);
